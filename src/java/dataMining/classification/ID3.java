 ...
 * Can only deal with nominal attributes. No missing values allowed. Empty
 * leaves may result in unclassified instances. For more information see: <br/>
 * <br/>
 ...
 */
public class ID3 extends AbstractClassifier implements Drawable, TechnicalInformationHandler, Sourcable {
    ...
    /**
     * Returns a string that describes the ID3 tree. The output is in dotty
     * format.
     *
